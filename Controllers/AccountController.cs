...
namespace projeto.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //     ICollection<SelectListItem> roles = _context.IdentityRole.Select(r => new SelectListItem
            //     {
            //             Text = r.Name,
            //             Value = r.Id
            //     }).ToList();
            // ViewData["IdentityRoleId"] = roles;
            ViewData["ReturnUrl"] = returnUrl;
            return View();
        }
        ...
        public IActionResult Create()
        {
            ...
            ViewData["SubjectUserId"] = new SelectList(_context.SubjectUser, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,ProfileImage,SubjectUserId,IdentityRoleId,Id,UserName,NormalizedUserName,Email,NormalizedEmail,EmailConfirmed,PasswordHash,SecurityStamp,ConcurrencyStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEnd,LockoutEnabled,AccessFailedCount")] ApplicationUser applicationUser)
        {
            ...
            ViewData["IdentityRoleId"] = new SelectList(_context.IdentityRole, "Id", "Id", applicationUser.IdentityRoleId);
            ViewData["SubjectUserId"] = new SelectList(_context.SubjectUser, "Id", "Id", applicationUser.SubjectUserId);
            return View(applicationUser);
        }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["IdentityRoleId"] = new SelectList(_context.IdentityRole, "Id", "Name", applicationUser.IdentityRoleId);
            ViewData["SubjectUserId"] = new SelectList(_context.SubjectUser, "Id", "Id", applicationUser.SubjectUserId);
            return View(applicationUser);
        }
